      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
          <div data-spy="affix" data-offset-top="15" data-offset-bottom="45">
            ...
            <br/>
            <br/>
            <a href="compraXclienteUSR.jsp"><input class="myButton" type="submit" value="Compras por Cliente"></a>

            <a href="ventasGeneralesUSR.jsp"><input class="myButton" type="submit" value="Ventas Generales y por Punto de Venta"></a> 
            <br/>
            <br/>
            <a href="inventarioUSR.jsp"><input class="myButton" type="submit" value="Inventario Actual"></a>

            <a href="infoProvedoresUSR.jsp"><input class="myButton" type="submit" value="Proveedores"></a>
            <br/>
            <br/>
            <a href="reporteFacturaUSR.jsp"><input class="myButton" type="submit" value="Facturas"></a>
    </
</html>