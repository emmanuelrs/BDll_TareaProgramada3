    ...
    <aside class="bg-dark">
        <div class="container text-center">
            <div class="call-to-action">
                ...
                <a href="facturacionUSR.jsp" class="btn btn-default btn-xl wow tada">Facturación</a>
                <a href="inventarioUSR.jsp" class="btn btn-default btn-xl wow tada">Inventario</a>
                <a href="reportesUSR.jsp" class="btn btn-default btn-xl wow tada">Reportes</a>
                <a href="infoProvedoresUSR.jsp" class="btn btn-default btn-xl wow tada">Proveedores</a>
            </div>
        </div>
    </aside>
    <!-- jQuery -->
